...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #111828 #6c63ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="images/logo.png">MediLife Hospital</h4></a>
