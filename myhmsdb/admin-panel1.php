...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Mulawekar Hospital </a>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Antenatal Care" name="spec">Antenatal Care</option>
                      <option value="Hair Loss" name="spec">Hair Loss </option>
                      <option value="Maternity" name="spec">Maternity</option>
                      <option value="Weight Loss" name="spec">Weight Loss</option>
                      <option value="Skin Care" name="spec">Skin Care</option>
                    </select>
                    </div><br><br>
